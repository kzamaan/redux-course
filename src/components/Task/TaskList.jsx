	...
	return (
		<div class="lws-task-list">
			...
			<div class="lws-task">
				...
				<div class="flex items-center gap-4">
					<div class="flex items-center gap-2">
						<img src={avatarImage4} class="team-avater" alt="image4" />
			...
			<div class="lws-task">
				...
				<div class="flex items-center gap-4">
					<div class="flex items-center gap-2">
						<img src={avatarImage1} alt="image52" class="team-avater" />
			...
			<div class="lws-task">
				...
				<div class="flex items-center gap-4">
					<div class="flex items-center gap-2">
						<img src={avatarImage6} alt="ferdous" class="team-avater" />
			...
			<div class="lws-task">
				...
				<div class="flex items-center gap-4">
					<div class="flex items-center gap-2">
						<img src={avatarImage2} alt="sadh" class="team-avater" />
			...
			<div class="lws-task">
				...
				<div class="flex items-center gap-4">
					<div class="flex items-center gap-2">
						<img src={avatarImage3} alt="akash" class="team-avater" />
